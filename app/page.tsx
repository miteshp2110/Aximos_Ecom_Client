      ...
      <main>
          ...
          <div className="container mx-auto px-4 z-10 relative">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Premium Digital Assets for Discerning Creators
              </h1>
              <p className="text-lg md:text-xl mb-8 text-gray-200">
                Elevate your projects with our curated collection of high-quality digital resources designed for
                professionals.
              </p>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              >
                Discover our most popular digital assets, handpicked for exceptional quality and versatility.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  All our digital assets are meticulously crafted to meet the highest standards of quality and design.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Your purchases are protected with state-of-the-art security measures and encryption.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Get immediate access to your purchased assets with our seamless delivery system.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Elevate Your Projects?</h2>
              <p className="text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied customers who have transformed their creative work with our premium digital
                assets.
              </p>
              <Button asChild size="lg" className="bg-accent text-primary hover:bg-accent/90">
